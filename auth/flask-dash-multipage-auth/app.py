"""
 CREDIT: This code is adapted for `pages`  https://github.com/AnnMarieW/dash-flask-login/blob/main/app.py
...
server.config.update(SECRET_KEY='SOME_SUPER_SECRET_KEY') # os.getenv("SECRET_KEY"))
